...
2. In the **Property Grid**, next to the property you want to control with the shader, click ![Blue arrow button](../../game-studio/media/blue-arrow-icon.png) (**Change**) and select **Shader**.
