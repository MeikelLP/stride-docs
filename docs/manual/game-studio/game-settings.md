...
1. In the **GameSettings** properties, next to **Default Scene**, click ![Hand icon](../game-studio/media/hand-icon.png) (**Select an asset**).
...
1. In the **GameSettings** properties, next to **Graphics compositor**, click ![Hand icon](../game-studio/media/hand-icon.png) (**Select an asset**).
