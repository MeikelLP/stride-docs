...
7. In the **Animation Start** properties, next to **Animations**, click ![Green plus button](../game-studio/media/green-plus-icon.png) (**Add**).
...
9. Next to **Add to Animations**, click ![Green plus button](../game-studio/media/green-plus-icon.png) (**Add**).
