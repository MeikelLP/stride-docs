...
3. Under **Selected groups**, click ![Green plus button](../game-studio/media/green-plus-icon.png) (**Add**).
...
4. Click ![Blue arrow button](../game-studio/media/blue-arrow-icon.png) (**Replace**) and choose a group from the drop-down menu.
