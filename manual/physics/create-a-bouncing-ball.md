...
4. Next to **Collider Shapes**, click ![Green plus button](../game-studio/media/green-plus-icon.png) (**Add**) and select **Infinite Plane**.
...
4. Next to **Collider Shapes**, click ![Green plus button](../game-studio/media/green-plus-icon.png) (**Add**) and select **Sphere**.
