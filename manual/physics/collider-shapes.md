...
2. Next to **Shape**, specify the collider shape asset you want to use.
    ...
    To do this, drag the asset from the **Asset View** to the **Shape** field in the Property Grid. Alternatively, click ![Hand icon](../game-studio/media/hand-icon.png) (**Select an asset**) and browse to the asset.
