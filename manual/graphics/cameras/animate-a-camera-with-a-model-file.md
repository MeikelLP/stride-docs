...
5. Next to **Animations**, click ![Green plus button](../../game-studio/media/green-plus-icon.png) (**Add**) and type a name.
...
6. Next to the animation you added, click ![Hand icon](../../game-studio/media/hand-icon.png) (**Select an asset**).
...
9. Under the script component, next to **Animations**, click ![Green plus button](../../game-studio/media/green-plus-icon.png) (**Add**).

    ![Add animation to the list](../../animation/media/add-animation-to-list.png)

10. Next to **Clip**, click ![Hand icon](../../game-studio/media/hand-icon.png) (**Select an asset**).
...
4. Next to **Target**, click ![Hand icon](../../game-studio/media/hand-icon.png) and select the entity that has the model you want to link the camera to.
