...
3. Under the **Animations** component, click ![Green plus button](../../game-studio/media/green-plus-icon.png) (**Add**).

    ![Add animation](media/add-new-playing-animation.png)

4. Type a name for the animation.

5. Next to **Clip**, click ![Hand icon](../../game-studio/media/hand-icon.png) (**Select an asset**).
...
10. Under the **Animation** component, under **Item 0**, click ![Hand icon](../../game-studio/media/hand-icon.png) (**Select an asset**).
...
3. Next to **Emitters**, click ![Green plus button](../../game-studio/media/green-plus-icon.png) (**Add**). This adds a new particle emitter.
...
6. Next to **Spawners**, click ![Green plus button](../../game-studio/media/green-plus-icon.png) (**Add**) and select **Per frame**.
...
7. Next to **Initializers**, click ![Green plus button](../../game-studio/media/green-plus-icon.png) (**Add**) and select **Velocity**.
...
9. Next to **Initializers**, click ![Green plus button](../../game-studio/media/green-plus-icon.png) (**Add**) and select **Direction**.
...
1. In the SwordModel properties, under **Particle System > Source > Emitters**, next to **Initializers**, click ![Green plus button](../../game-studio/media/green-plus-icon.png) (**Add**) and select **Spawn Order**.
...
3. In the **SwordModel** properties, expand **Emitters > Material**. Click ![Hand icon](../../game-studio/media/hand-icon.png) (**Select an asset**). Browse to the **Textures** folder and select **swoosh.png**.
...
9. Under the **SpawnTrail** component properties, next to **Source**, click ![Hand icon](../../game-studio/media/hand-icon.png) (**Select an asset**).
