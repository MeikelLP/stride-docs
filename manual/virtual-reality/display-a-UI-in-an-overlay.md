...
3. Next to **Game rendererer**, click ![Blue arrow button](../game-studio/media/blue-arrow-icon.png) (**Replace**) and select **Camera Renderer**.
...
4. Next to **Camera**, click ![Blue arrow button](../game-studio/media/blue-arrow-icon.png) (**Replace**) and select your main game camera.

    ![Select main camera](media/select-main-camera.png)

5. Next to **Child**, click ![Blue arrow button](../game-studio/media/blue-arrow-icon.png) (**Replace**) and select **SceneRendererCollection**.

    ![Select scene renderer collection](media/select-scene-renderer-collection.png)

6. Next to **Children**, Click ![Green plus button](../game-studio/media/green-plus-icon.png) (**Add**) and select **RenderTextureSceneRenderer**.

    ![Select RenderTextureSceneRenderer](media/select-RenderTextureSceneRenderer.png)

7. Next to **Child**, click ![Blue arrow button](../game-studio/media/blue-arrow-icon.png) (**Replace**) and select **SingleStageRenderer**.

    ![Select single stage renderer](media/select-single-stage-renderer.png)

8. Next to **Render Stage**, click ![Blue arrow button](../game-studio/media/blue-arrow-icon.png) (**Replace**) and select **UIRenderStage**. This is the renderer that renders the UI.

    ![Select UI render stage](media/select-UI-render-stage.png)

9. Next to **Render Texture**, click ![Hand icon](../game-studio/media/hand-icon.png) (**Select an asset**).
...
11. Under **Game renderer**, next to **Children**, click ![Green plus button](../game-studio/media/green-plus-icon.png) (**Add**) and select **Forward renderer**.
